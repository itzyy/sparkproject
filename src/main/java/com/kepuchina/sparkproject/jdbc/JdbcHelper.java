package com.kepuchina.sparkproject.jdbc;
 ...
 * JDBC辅助组件
 * <p>
 * 在正式的项目的代码编写过程中，是完全严格按照大公司的codeing标准来的
...
public class JdbcHelper {
    ...
    static {
        String driverClass = ConfigurationManager.getProperty(Constants.JDBC_DRIVER);
        try {
    ...
    private JdbcHelper() {
        //首先第一步，获取数据库连接池的大小，就是说，数据连接池中要放多少个数据库连接
